...
1.  **Installation de l'app en local** :
    Installer GIT.
    * se placer sur le dossier dans lequel on veut mettre l'application (cd)
    * git clone https://github.com/HibonTitouan/PROG_WEB_Dashboard_FRANCE-TRAVAIL.git
...
2.  **Installation des dépendances** :
   ...
   installer node js : https://nodejs.org/dist/v24.11.1/node-v24.11.1-x64.msi
    ```
3.  **Lancement Simulation Base de données en ligne** :
   Lancer Xampp. 
